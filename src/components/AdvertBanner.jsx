...
function AdvertBanner() {
  ...
  return (
    <div className="alert alert-dismissible fade show items-center justify-between rounded-sm mb-1 bg-blue-600 py-4 px-6 text-center text-white md:flex md:text-left">
      <div className="mb-4 flex flex-wrap items-center justify-center md:mb-0 md:justify-start">
        ...
        <strong className="mr-1">Advertise with us!</strong> Promote Your Products or services and Boost Your Brand Awareness.
      </div>
